...
def getDiff(coin,interval):
    ...
    for i in range(1,length):
        ...
        if((time.minute + 60*time.hour -330) % temp == 0):
...
def gulian(df, length,coin):
    ...
    canBuy = l3Arr1[48] >= 0.1 and l3Arr2[48] >=0.1 and l3Arr3[48] >=0.1 and l3Arr1[47] < l3Arr1[48] #and l3Arr2[47] < l3Arr2[48] and l3Arr3[47] < l3Arr3[48] 
    
    canSell = (l3Arr1[48] < 0.2 and l3Arr1[47] - l3Arr1[48] > 0.07) or  l3Arr1[48] < 0.05 #or l3Arr2[48] < 0.1 or l3Arr3[48] < 0.1  #and l3Arr3[48] <= 0.05 and l3Arr3[48] <= 0.05
...
def collectData(coin, length):
    ...
    try:
        ...
        if(getAvg(df, length) > 0.5 ):
            ...
            if(canBuy and getPerc(df['close'][length-2],df['open'][length-2]) < 2*getAvg(df, length) and df['ema'][length-2] > df['ema'][length-3]):
